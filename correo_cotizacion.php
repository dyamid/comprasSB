...
if($tipoGuardar == 'EnviarCorreoCotizacion'){
    ...
    // Definir la variable $cadena fuera de las condiciones para evitar errores de variable no definida.
    $cadena = '';
    ...
    if($totalRows_RsProveedor > 0){
        ...
        // Generar la cadena aleatoria aquí, asegurando que siempre se defina antes de usarla.
        ...
        if($totalRows_RsDetallesCorreo > 0) {							  
            $tema .= '<table width="100%" align="center" style="background:#F3F3F3;padding:10px 20px;font-weight:bold; text-align:center;">
                         <tbody>
                             <tr>
                                 <td>
